    ...
    export default {
        ...
        data() {
            return {
                ...
                splaces:false,
                scylindre:false,
                spremiereMiseEnCirculation:false,
                senergie:false,
        ...
        methods:{
            ...
            setchassis(value){
                ...
                this.$store.state.cg.chassis = value.item.chassis

                console.log('this.chassis', this.$store.state.cg.chassis)
                this.loaddatavehicule(value.item)
            },
            ...
            loadvehicule(data){
                ...
                console.log('marqueVehiculeId',data)
                ...
                console.log('datedebutvalid',this.dateDebutValid)
                console.log('dateFinValid',this.dateFinValid)
                console.log('dateDelivrance',this.dateDebutValid)

               // this.dateDebutValid = (this.dateDebutValid==null)?"":this.customFormatter(data.dateDebutValid)
                this.dateDebutValid = data.dateDebutValid

                this.dateFinValid = data.dateFinValid

                this.dateDelivrance = data.dateDelivrance
                ...
                console.log('energieId',data.vehicule.premiereMiseEnCirculation==null)

                this.premiereMiseEnCirculation = data.vehicule.premiereMiseEnCirculation==null?null:this.customFormatter(data.vehicule.premiereMiseEnCirculation)
            ...
            registerCg: function(){
                ...
                if (this.$v.$invalid) {
                   ...
                   // console.log('premiereMiseEnCirculations',this.premiereMiseEnCirculation.length)
                    // do your submit logic here
                    this.submitStatus = "PENDING";

                    if(this.premiereMiseEnCirculation==null){
                    ...
                    if(this.marqueVehiculeId.length===0){
                        this.makeToast(this.$t('errormarque'),'error')
                        return ;
                    }
                    ...
                    setTimeout(() => {
                        ...
                        if(this.vehiculeId !== 0){
                            ...
                            formData.append('vehiculeId',this.vehiculeId)
        ...
        mounted(){
            ...
            if ( (typeof this.rowes !== "undefined")){
                ...
                //this.checkdocument(this.document)
                console.log("smarquee",this.rowes)
                console.log("smarquees",this.rowes.carteGrise)
                this.loadvehicule(this.rowes.carteGrise)
            ...
            console.log('rowea', this.cat.produitId)
