    ...
    <b-modal :id="id" :title="title" :show="statut" size="xl" hide-footer>
        ...
        <template #default="{ hide }">
            <b-overlay :show="show" rounded="sm">
                <b-form :aria-hidden="show ? 'true' : null" @submit.prevent="registerCatProducts(type)">
    ...
    export default {
        ...
        methods:{
            registerCatProducts: function(item){
                ...
                let test={}
                test = { variant:item, libelle: this.nom,
                ...
                if (this.$v.$invalid) {
                    ...
                    setTimeout(() => {
                        ...
                        this.$emit("registercatproducts",test);
                    }, 1000);
                }
