                ...
                <b-card
                    ...
                    <b-tabs pills >
                        <b-tab title="" >
                            ...
                            <!--<ListGraph :name_graph="percent_visit" :datae="list_camembert"
                            :listhisto="list_hist"></ListGraph>-->
...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapGetters(["GETLISTSOINS",]),
        },
        methods: {
            ...mapActions(["FetchListTreatments"]),
            addpatient(){
