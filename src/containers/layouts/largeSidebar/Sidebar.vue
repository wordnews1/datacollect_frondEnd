<template>
  ...
  >
    ...
    >
      <div>
        <ul class="navigation-left" style="width:90px!important">

          <li
              v-if="this.$store.state.authData.role.indexOf('caissier') !== -1
              || this.$store.state.authData.role.indexOf('chef') !== -1"
          ...
          >
            ...
            <a class="nav-item-hold" href="#">
              <router-link tag="a" class to="/app/box">
              <i class="nav-icon i-Cash-register-2"></i>
              <span class="nav-text">{{ $t("caisse") }}</span>
              </router-link>
            </a>
            ...
            <li
                    v-if="this.$store.state.authData.role.indexOf('cg') !== -1
              || this.$store.state.authData.role.indexOf('chef') !== -1"
                    @mouseenter="toggleSubMenu"
                    :class="{ active: selectedParentMenu == 'dashboards' }"
                    class="nav-item"
            ...
            >
                ...
                <a class="nav-item-hold" href="#">
                    <router-link tag="a" class to="/app/cg">
                        <i class="nav-icon i-Cash-register-2"></i>
                        <span class="nav-text">{{ $t("updatecg") }}</span>
                    </router-link>
                </a>
...
<!--              <li class="nav-item">
   ...
   <!-- <vue-perfect-scrollbar
    ...
    >
      <div ref="sidebarChild">
        &lt;!&ndash; Submenu Dashboards &ndash;&gt;
        <ul
          class="childNav d-none"
...
export default {
  ...
  mounted() {
    ...
    this.adrReport = constants.reporting_link;
  },
